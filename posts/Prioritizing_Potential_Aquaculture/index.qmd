...
depth <- rast("posts/Prioritizing_Potential_Aquaculture/data/depth.tif")
eez <- st_read("posts/Prioritizing_Potential_Aquaculture/data/wc_regions_clean.shp", quiet = TRUE)
sst <- c(rast("posts/Prioritizing_Potential_Aquaculture/data/average_annual_sst_2012.tif"),
         rast("posts/Prioritizing_Potential_Aquaculture/data/average_annual_sst_2011.tif"),
         rast("posts/Prioritizing_Potential_Aquaculture/data/average_annual_sst_2010.tif"),
         rast("posts/Prioritizing_Potential_Aquaculture/data/average_annual_sst_2009.tif"),
         rast("posts/Prioritizing_Potential_Aquaculture/data/average_annual_sst_2008.tif"))
